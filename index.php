...
<br/><br/>
    ...
    <script src="js/slider/jssor.slider-22.2.16.min.js" type="text/javascript"></script>
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:1500px;height:600px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1500px;height:600px;overflow:hidden;">
            <div>
                <img data-u="image" src="/images/download1.jpg" />
                    ...
                    <div style="position:absolute;top:15px;left:15px;width:500px;height:40px;z-index:0;font-size:30px;color:#000000;line-height:40px;">Park Your Vehicle As per your desire</div>
                    <div style="position:absolute;top:60px;left:15px;width:500px;height:40px;z-index:0;font-size:22px;color:#000000;line-height:38px;">Explore rajasthan with modernization</div>
                </div>
            </div>
            <div>
                <img data-u="image" src="/images/download2.jpg" />
                                <div style="position:absolute;top:370px;left:100px;width:600px;height:120px;z-index:0;background-color:rgba(255,255,255,0.5);">
                    <div style="position:absolute;top:15px;left:15px;width:500px;height:40px;z-index:0;font-size:30px;color:#000000;line-height:40px;">Park Your Vehicle As per your desire</div>
                    <div style="position:absolute;top:60px;left:15px;width:500px;height:40px;z-index:0;font-size:22px;color:#000000;line-height:38px;">Explore rajasthan with modernization</div>
                </div>
            ...
            <div>
                <img data-u="image" src="/images/download3.jpg" />
